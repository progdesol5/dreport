    ...
    public static void ProcessReport()
    {
      ...
      foreach (DataRow dRow in distinctDeptName.Rows)
      {
        ...
        if (dRow["DeptName"].ToString() != "")
        {
          ...
          DataTable distinctValues = view.ToTable(true, "ManagerEmail");
          EmailHelper.SendEmail(subject, Ourcontant, "idrissawerwala@gmail.com");
          if (ConfigurationManager.AppSettings["IsTest"] == "true")
          {
      ...
      /*if (countMail > 0)
      { EmailHelper.SendEmail("RoyalHayat email for SReport: " + countMail, "Successfully sent " + countMail, "sayzaf@gmail.com,johar@writeme.com,yehia.khafaja@royalehayat.com"); }
