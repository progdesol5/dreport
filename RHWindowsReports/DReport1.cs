...
namespace RHReportScheduler
{
    public static class DReport1
    {
        public static void ProcessReport()
        {
            ...
            foreach (DataRow dRow in distinctDeptName.Rows)
            {
                ...
                if (dRow["DeptName"].ToString() != "")
                {
                    ...
                    if (ConfigurationManager.AppSettings["IsTest"] == "true")
                    {
                        ...
                        EmailHelper.SendEmail(subject, Ourcontant, "idrissawerwala@gmail.com;ginu.george@royalehayat.com;johar@writeme.com;yehia.khafaja@royalehayat.com;y.khafaja@gmail.com");//sonia25sep@gmail.com
            ...
            if (countMail > 0)
            { EmailHelper.SendEmail("RoyalHayat DReport Sent : " + countMail + "mail- between " + sdt1 + " And " + Edt1, "Sent :" + countMail  + " email " + "between " + sdt1 + " And " + Edt1, "idrissawerwala@gmail.com;johar@writeme.com;yehia.khafaja@royalehayat.com;y.khafaja@gmail.com"); }
            else { EmailHelper.SendEmail("RoyalHayat DReport Sent : " + countMail + " mail - between " + sdt1 + " And " + Edt1, "No Mail sent for period between " + sdt1 + " And " + Edt1, "idrissawerwala@gmail.com;johar@writeme.com;yehia.khafaja@royalehayat.com;y.khafaja@gmail.com"); }
        }
        private static string GetHtmlTable(DataTable dt)
        {
            ...
            try
            {
                ...
                foreach (DataRow dRow in dt.Rows)
                {
                    ...
                    string dat = dt1.ToString("dd-MM-yyyy HH:mm:ss");
