<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="ICSUBCATEGORY.aspx.cs" Inherits="Web.Master.ICSUBCATEGORY" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                                ...
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtSHORTNAME" runat="server" CssClass="form-control"></asp:TextBox>
                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidatorCATNAME" runat="server" ControlToValidate="txtSHORTNAME" ErrorMessage="Short Name ENG Required." CssClass="Validation" ValidationGroup="submit" Display="Dynamic"></asp:RequiredFieldValidator>
                                                                    </div>
                                                        ...
                                                        <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblSUBCATNAME1s" class="col-md-4 control-label" Text="Sub Category ENG"></asp:Label><asp:TextBox runat="server" ID="txtSUBCATNAME1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtSUBCATNAME" runat="server" CssClass="form-control"></asp:TextBox>
                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSUBCATNAME" ErrorMessage="Sub Category ENG Required." CssClass="Validation" ValidationGroup="submit" Display="Dynamic"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblSUBCATNAME2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSUBCATNAME2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblSUBCATNAMEO1s" class="col-md-4 control-label" Text="Sub Category ARA"></asp:Label><asp:TextBox runat="server" ID="txtSUBCATNAMEO1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtSUBCATNAMEO" runat="server" CssClass="form-control"></asp:TextBox>
                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSUBCATNAMEO" ErrorMessage="Sub Category ARA Required." CssClass="Validation" ValidationGroup="submit" Display="Dynamic"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblSUBCATNAMEO2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSUBCATNAMEO2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <%-- </div>
                                                        <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblSUBCATNAMEO21s" class="col-md-4 control-label" Text="Sub Category FRA"></asp:Label><asp:TextBox runat="server" ID="txtSUBCATNAMEO21s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtSUBCATNAMEO2" runat="server" CssClass="form-control"></asp:TextBox>
                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSUBCATNAMEO2" ErrorMessage="Sub Category FRA Required." CssClass="Validation" ValidationGroup="submit" Display="Dynamic"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblSUBCATNAMEO22h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtSUBCATNAMEO22h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                            <asp:Label runat="server" ID="lblhSUBCATNAME" Text="Sub Category ENG"></asp:Label></th>
                                                        <th>
                                                            <asp:Label runat="server" ID="lblhSUBCATNAMEO" Text="Sub Category ARA"></asp:Label></th>
                                                        <th>
                                                            <asp:Label runat="server" ID="lblhSUBCATNAMEO2" Text="Sub Category FRA"></asp:Label></th>
                                                    ...
                                                    <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblSUBCATNAME" runat="server" Text='<%# Eval("SUBCATNAME")%>'></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="lblSUBCATNAMEO" runat="server" Text='<%# Eval("SUBCATNAMEO")%>'></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="lblSUBCATNAMEO2" runat="server" Text='<%# Eval("SUBCATNAMEO2")%>'></asp:Label></td>

                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("SUBCATID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                           <%-- <td>
                                                                                <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("SUBCATID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>--%>
