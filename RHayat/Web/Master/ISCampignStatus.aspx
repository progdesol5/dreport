<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="ISCampignStatus.aspx.cs" Inherits="Web.Master.ISCampignStatus" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorStatus" runat="server" ControlToValidate="txtStatus" ErrorMessage="Status Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                        ...
                                                        <div class="row">--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblCreatedDateTime1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCreatedDateTime1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:TextBox Placeholder="DD/MM/YYYY" ID="txtCreatedDateTime" runat="server" CssClass="form-control"> </asp:TextBox>
                                                                        <cc1:CalendarExtender ID="TextBoxCreatedDateTime_CalendarExtender" runat="server" Enabled="True" PopupButtonID="calender" TargetControlID="txtCreatedDateTime" Format="dd/MM/yyyy"></cc1:CalendarExtender>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorCreatedDateTime" runat="server" ControlToValidate="txtCreatedDateTime" ErrorMessage="Createddatetime Required." CssClass="Validation" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" TargetControlID="txtCreatedDateTime" ValidChars="/" FilterType="Custom, numbers" runat="server" />
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblCreatedDateTime2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtCreatedDateTime2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                       <%-- <div class="row">
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhStatus" Text="Status"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhCreatedDateTime" Text="Createddatetime"></asp:Label></th>
                                                                                                ...
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand">
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblCreatedDateTime" runat="server" Text='<%# Eval("CreatedDateTime")%>'></asp:Label></td>
