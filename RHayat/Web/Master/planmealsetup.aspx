<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="planmealsetup.aspx.cs" Inherits="Web.Master.planmealsetup" %>
                                                                    ...
                                                                    <div class="portlet-body">
                                                                        <asp:Panel ID="pnlhide" Visible="false" runat="server">
                                                                            ...
                                                                            <table class="table table-striped table-hover table-bordered">
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:DropDownList ID="drpProduct" CssClass="form-control select2me input-xlarge" runat="server"></asp:DropDownList>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <table>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit11" CommandArgument='<%# Eval("PlanID")+","+ Eval("MealType")+","+ Eval("MYPRODID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                        <td>
                                                                                                            <asp:LinkButton ID="btnDelete" CommandName="btnDelete11" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("PlanID")+","+ Eval("MealType")+","+ Eval("MYPRODID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>
