<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AcmMaster.Master" AutoEventWireup="true" CodeBehind="HBContract.aspx.cs" Inherits="Web.Master.HBContract" %>
                                                                ...
                                                                <div class="portlet box green">
                                                                    <div class="portlet-title">
                                                                        ...
                                                                        <div class="actions btn-set">
                                                                            ...
                                                                            <asp:Button ID="btnaddItems" runat="server" class="btn yellow btn-circle" Text="Add Item" />
                                                                            ...
                                                                            <asp:Panel ID="PanelConfirmmsg" runat="server" Style="display: none; height: 75%; overflow: auto">
                                                                                ...
                                                                                <div class="row" style="position: fixed; left: 15%; width: 50%; top: 1%;">
                                                                                    <div class="col-md-12">
                                                                                            ...
                                                                                            <div class="portlet box yellow">
                                                                                                <div class="portlet-title">
                                                                                                    <div class="caption">
                                                                                                        ...
                                                                                                        <asp:Label runat="server" ID="Label102" Style="width: 252px; padding-top: 0px;" ForeColor="White" class="col-md-4 control-label" Text="Add Items"></asp:Label>

                                                                                                    </div>
                                                                                                    <div class="actions btn-set">
                                                                                                        <asp:Button ID="Button6" runat="server" class="btn red-flamingo btn-circle" Text="Cancel" />
                                                                                                    </div>

                                                                                                </div>
                                                                                                <div id="Div2" runat="server" class="portlet-body">
                                                                                                    <div class="tabbable" style="color:#000;">
                                                                                                        <div class="tab-content no-space">
                                                                                                                ...
                                                                                                                <div class="portlet-body">
                                                                                                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                                                                                        <thead class="repHeader">
                                                                                                                            <tr>
                                                                                                                                <th></th>
                                                                                                                                <th> <asp:Label ID="lblname" ForeColor="Black" runat="server" Text="Product Name"></asp:Label></th>
                                                                                                                                <th> <asp:Label ID="Label103" ForeColor="Black" runat="server" Text="UOM"></asp:Label></th>
                                                                                                                                <th> <asp:Label ID="lblAction" ForeColor="Black" runat="server" Text="Action"></asp:Label></th>
                                                                                                                            </tr>
                                                                                                                        </thead>
                                                                                                                        <tbody>
                                                                                                                            <asp:ListView ID="ListView5" runat="server"  OnItemCommand="ListView5_ItemCommand">
                                                                                                                                <ItemTemplate>
                                                                                                                                    <tr>
                                                                                                                                        <td style="width:5%;"> <asp:Label ID="Label105" runat="server" Text='<%# Container.DataItemIndex+1 %>'></asp:Label></td>
                                                                                                                                        <td>
                                                                                                                                            <asp:Label ID="lblProdName" ForeColor="Black" runat="server" Text='<%# getProdname(Convert.ToInt64(Eval("MYPRODID"))) %>'></asp:Label>
                                                                                                                                            <asp:Label ID="lblprodID" Visible="false" runat="server" Text='<%# Eval("MYPRODID") %>'></asp:Label>
                                                                                                                                        </td>
                                                                                                                                        <td style="width:20%;">
                                                                                                                                            <asp:Label ID="Label104" ForeColor="Black" runat="server" Text='<%# GetUOM(Convert.ToInt32(Eval("UOM"))) %>'></asp:Label>

                                                                                                                                        </td>
                                                                                                                                        <td style="width:10%;">
                                                                                                                                            <asp:LinkButton ID="lnkbtnItem" CssClass="btn green" runat="server" CommandName="AddItem" CommandArgument='<%# Eval("MYPRODID")+ "," + Eval("UOM") %>' Text="Select"></asp:LinkButton>
                                                                            ...
                                                                            <cc1:ModalPopupExtender ID="ModalPopupExtender11" runat="server" DynamicServicePath="" BackgroundCssClass="" CancelControlID="Button6" Enabled="True" PopupControlID="PanelConfirmmsg" TargetControlID="btnaddItems"></cc1:ModalPopupExtender>
                                                                        ...
                                                                        <table class="table table-striped table-hover table-bordered">
                                                                            <thead>
                                                                                ...
                                                                                <tr style="border: 1px solid gray;">
                                                                                    ...
                                                                                    <th>
                                                                                        <asp:Button ID="btnCopyWeekWise" runat="server" class="btn btn-sm green" Text="Copy Full Plan" OnClientClick="showProgress()" OnClick="btnCopyWeekWise_Click" />  
                                                                                ...
                                                                                <tr style="border: 1px solid gray; border-bottom: 1px solid gray; background: #e6ffee none repeat scroll 0 0;">
                                                                                    ...
                                                                                    <th style="width: 5%;">Cal</th>
                                                                                    <th style="width: 5%;">Prot</th>
                                                                                    <th style="width: 5%;">Cbs</th>
                                                                                    <th style="width: 5%;">Fat</th>
                                                                                    <th style="width: 5%;">Wght</th>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <asp:ListView ID="ListView2" runat="server" OnItemCommand="ListView2_ItemCommand" OnItemDataBound="ListView2_ItemDataBound">
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div style="width: 73%; position: relative; float: left;">
                                                                                                ...
                                                                                                <div style="width: 25%; position: relative; float: right;">
                                                                                                    <asp:DropDownList ID="drpUOM" Width="100%" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpUOM_SelectedIndexChanged" onchange="showProgress()" ></asp:DropDownList>
                                                                                                    <asp:Label ID="lblUOM" runat="server" Visible="false" Text='<%# Eval("UOM") %>'></asp:Label>
                                                                                                    <asp:Label ID="lblSetUOM" runat="server" Visible="false" Text=""></asp:Label>

                                                                                                    <%--CssClass="form-control select2me input-xsmall"--%>
                                                                        ...
                                                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th>
                                                                                        <asp:Label ID="Label106" runat="server" Text="UOM"></asp:Label></th>
                                                                                    <th>
                                                                                ...
                                                                                <asp:ListView ID="Listview3" runat="server">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:Label ID="Label107" runat="server" Text='<%# GetUOM(Convert.ToInt32(Eval("UOM"))) %>'></asp:Label></td>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:Label ID="Label20" runat="server" Text='<%# Convert.ToDateTime(Eval("ExpectedDelDate")).ToString("dd-MMM-yyyy") %>'></asp:Label></td>
                                                                                            <td>
                                                    ...
                                                    <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="Label14" runat="server" Text='<%# Eval("MYTRANSID") %>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lblCustomer" runat="server" Text='<%# GetCustomer(Convert.ToInt32( Eval("CustomerID")))%>'></asp:Label>
                                                                    <asp:Label ID="lblMYTRANSID" runat="server" Visible="false" Text='<%# Eval("MYTRANSID")%>'></asp:Label>
