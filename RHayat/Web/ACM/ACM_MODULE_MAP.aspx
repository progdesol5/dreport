<%@ Page Title="" Language="C#" MasterPageFile="~/ACM/ACMMaster.Master" AutoEventWireup="true" CodeBehind="MODULE_MAP.aspx.cs" Inherits="NewHRM.MODULE_MAP" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_ID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_ID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        ...
                                                                        <asp:RequiredFieldValidator CssClass="Validation" ID="RequiredFieldValidatorMASTER_ID" runat="server" ErrorMessage="PRIVILEGE  name Required." ControlToValidate="drpPRIVILEGE_ID" ValidationGroup="s" InitialValue="0"></asp:RequiredFieldValidator>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblMODULE_ID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMODULE_ID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        ...
                                                                        <asp:RequiredFieldValidator CssClass="Validation" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Module  name Required." ControlToValidate="drpMODULE_ID" ValidationGroup="s" InitialValue="0"></asp:RequiredFieldValidator>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <%--<div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblMODULE_MAP_ID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMODULE_MAP_ID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpMODULE_MAP_ID" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblMODULE_MAP_ID2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMODULE_MAP_ID2h" class="col-md-4 control-label" Visible="false"></asp:TextBox></div>
                                                            </div>--%>

                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblUserID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtUserID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpUserID" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblMySerial1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtMySerial1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpMySerial" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                    </div>
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhMODULE_MAP_ID" Text="Module Map  Name"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhMySerial" Text="Myserial"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhADD_FLAG" Text="Add Flag"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhDELETE_FLAG" Text="Delete Flag"></asp:Label></th>

                                                                                                    <th style="width: 60px;">ACTION</th>
                                                                                                </tr>
                                                                                            </thead>
                                                                                            <tbody>
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="TenentID,PRIVILEGE_ID,MODULE_ID,MODULE_MAP_ID,UserID,ACTIVE_FLAG,TenantID,CRUP_ID,MySerial,ALL_FLAG,ADD_FLAG,MODIFY_FLAG,DELETE_FLAG,VIEW_FLAG" DataKeyNames="TenentID,PRIVILEGE_ID,MODULE_ID,MODULE_MAP_ID,UserID,ACTIVE_FLAG,TenantID,CRUP_ID,MySerial,ALL_FLAG,ADD_FLAG,MODIFY_FLAG,DELETE_FLAG,VIEW_FLAG">
                                                                                                    <LayoutTemplate>
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblMODULE_MAP_ID" runat="server" Text='<%# Eval("MODULE_MAP_ID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblMySerial" runat="server" Text='<%# Eval("MySerial")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblADD_FLAG" runat="server" Text='<%# Eval("ADD_FLAG")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblDELETE_FLAG" runat="server" Text='<%# Eval("DELETE_FLAG")%>'></asp:Label></td>

                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("MODULE_MAP_ID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <%--<td>
                                                                                                                            <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("MODULE_MAP_ID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>--%>
