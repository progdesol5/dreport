<%@ Page Title="" Language="C#" MasterPageFile="~/ACM/ACMMaster.Master" AutoEventWireup="true" CodeBehind="tbltranstype.aspx.cs" Inherits="Web.ACM.tbltranstype" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbltranstype11s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype11s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txttranstype1" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbltranstype12h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype12h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbltranstype21s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype21s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txttranstype2" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbltranstype22h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype22h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbltranstype31s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype31s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txttranstype3" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbltranstype32h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype32h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <asp:Label runat="server" ID="lblserialno2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtserialno2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblinoutSwitch1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtinoutSwitch1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtinoutSwitch" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblinoutSwitch2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtinoutSwitch2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <asp:Label runat="server" ID="lblyears2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtyears2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbltranstype1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txttranstype" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lbltranstype2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txttranstype2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhMYSYSNAME" Text="My sysname"></asp:Label></th>
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhtranstype1" Text="Trans type Name 1"></asp:Label></th>
                                                                                                    <th>
                                                                                                ...
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand">
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Label ID="lbltranstype1" runat="server" Text='<%# Eval("transtype1")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("transid")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <td>
