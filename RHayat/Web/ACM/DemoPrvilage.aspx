<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DemoPrvilage.aspx.cs" Inherits="Web.ACM.DemoPrvilage" %>
...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo" onkeydown="disableF5();">
    <!-- BEGIN HEADER -->
            ...
            <ContentTemplate>
                <div class="page-header navbar navbar-fixed-top">
                    ...
                    <div class="page-header-inner">
                        ...
                        <!-- BEGIN PAGE ACTIONS -->
                        <!-- class="page-actions scrollmenu" style="width: 45%;" -->
                            ...
                            <div class="top-menu">
                                <ul class="nav navbar-nav pull-right">
                                    ...
                                    <li class="dropdown dropdown-user dropdown-dark">
                                        ...
                                        <a style="padding: 0px;margin-top: -3px;">--%><br />
                                        ...
                                        <%--<asp:Label ID="lblrole" runat="server"></asp:Label>--%>
                                            ...
                                            <asp:Label ID="lblpageid" runat="server"></asp:Label></a>
                                    ...
                                    <a href="extra_lock.html">
                                        <i class="icon-lock"></i> Lock Screen
                                            ...
                                            <li>
                                                ...
                                                <asp:LinkButton ID="linkClickTicket" runat="server" OnClick="linkClickTicket_Click"><i class="icon-key"></i> Click Ticket</asp:LinkButton>
        ...
        <div class="page-container" style="padding-left: 5px; padding-top: 5px;">
            ...
            <div class="page-content-wrapper">
                <div class="page-content" style="padding-top: 0px; padding-left: 0px;">
                    ...
                    <iframe runat="server" id="ifrm" name="ifrm" frameborder="0" clientidmode="Static" width="100%" style="overflow: hidden"></iframe>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $.sessionTimeout({
                ...
                warnAfter: 24000000, //warn after 20 Min 
                redirAfter: 24500000, //redirect after 21 Min 
            });
        });
    </script>
    <!-- END JAVASCRIPTS -->
