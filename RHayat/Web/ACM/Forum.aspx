<%@ Page Title="" Language="C#" MasterPageFile="~/ACM/ACMMaster.Master" AutoEventWireup="true" CodeBehind="Forum.aspx.cs" Inherits="Web.ACM.Forum" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorForumTopic" runat="server" ControlToValidate="txtForumTopic" ErrorMessage="ForumTopic Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lbluserid" class="col-md-4 control-label" Visible="false"></asp:Label><asp:TextBox runat="server" ID="TextBox1" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:TextBox TextMode="MultiLine" ID="txtlbluser" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblAvtar1s" class="col-md-4 control-label"></asp:Label>
                                                                    <asp:TextBox runat="server" ID="txtAvtar1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                                    ...
                                                                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                        <thead>
                                                                                            <tr>
                                                                                                ...
                                                                                                <th>
                                                                                                    <asp:Label runat="server" ID="lblhForumTopic" Text="ForumTopic"></asp:Label></th>
                                                                                                <th>
                                                                                                    <asp:Label runat="server" ID="lblhCategoryID" Text="Category Name"></asp:Label></th>
                                                                                                <th>
                                                                                                    <asp:Label runat="server" ID="lblimageblog" Text="Images"></asp:Label>
                                                                                                </th>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="ID,ForumTopic,Description,CategoryID,UserID,Active,DateTime,Deleted,Visited,DisplayName,Avtar" DataKeyNames="ID,ForumTopic,Description,CategoryID,UserID,Active,DateTime,Deleted,Visited,DisplayName,Avtar">
                                                                                                <LayoutTemplate>
                                                                                                ...
                                                                                                <ItemTemplate>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <asp:Label ID="lblImages" runat="server" Text='<%# Eval("Avtar") %>'></asp:Label>
                                                                                                        </td>
