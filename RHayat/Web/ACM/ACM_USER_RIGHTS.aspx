<%@ Page Title="" Language="C#" MasterPageFile="~/ACM/ACMMaster.Master" AutoEventWireup="true" CodeBehind="USER_RIGHTS.aspx.cs" Inherits="Web.ACM.USER_RIGHTS" %>
        ...
        <div class="col-md-12">
            <div class="tabbable-custom tabbable-noborder">
                ...
                <asp:Panel ID="pnlSuccessMsg" runat="server" Visible="false">
                 ...
                 <asp:Panel ID="PNALGOL" runat="server" Visible="false"><div class="row">
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            <%-- <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblRIGHTS_ID1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtRIGHTS_ID1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="drpRIGHTS_ID" runat="server" CssClass="table-group-action-input form-control input-medium"></asp:DropDownList>
                                                                      
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblRIGHTS_ID2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtRIGHTS_ID2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>--%>
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblIsLabelUpdate1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtIsLabelUpdate1s" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:CheckBox ID="cbIsLabelUpdate" runat="server" />
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblIsLabelUpdate2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtIsLabelUpdate2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                        ...
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:Label runat="server" ID="lblhRIGHTS_ID" Text="Rights ID"></asp:Label></th>
                                                                                                    <th>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="TenentID,RIGHTS_ID,USER_ID,PRIVILEGE_ID,ADD_FLAG,MODIFY_FLAG,DELETE_FLAG,VIEW_FLAG,ALL_FLAG,CRUP_ID,IsLabelUpdate" DataKeyNames="TenentID,RIGHTS_ID,USER_ID,PRIVILEGE_ID,ADD_FLAG,MODIFY_FLAG,DELETE_FLAG,VIEW_FLAG,ALL_FLAG,CRUP_ID,IsLabelUpdate">
                                                                                                    <LayoutTemplate>
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:Label ID="lblRIGHTS_ID" runat="server" Text='<%# Eval("RIGHTS_ID")%>'></asp:Label></td>
                                                                                                            <td>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tr>
                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("RIGHTS_ID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                                                                        <%--                                                                                                                        <td>
                                                                                                                            <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("RIGHTS_ID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>--%>
