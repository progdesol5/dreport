<%@ Page Title="" Language="C#" MasterPageFile="~/ACM/ACMMaster.Master" AutoEventWireup="true" CodeBehind="PRIVILEGE_MST.aspx.cs" Inherits="Web.ACM.PRIVILEGE_MST" %>
                                                ...
                                                <div class="tab-pane active" id="tab_general1">
                                                    <div class="form-body">
                                                        <%-- <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblLocation" class="col-md-4 control-label">Location</asp:Label><asp:TextBox runat="server" ID="TextBox1" class="col-md-4 control-label" Visible="false"></asp:TextBox><div class="col-md-8">
                                                                        <asp:DropDownList ID="DrpLocation" runat="server" CssClass="table-group-action-input form-control input-medium" AutoPostBack="true" OnSelectedIndexChanged="DrpLocation_SelectedIndexChanged"></asp:DropDownList>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_NAME1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_NAME1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtPRIVILEGE_NAME" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPRIVILEGE_NAME" runat="server" ControlToValidate="txtPRIVILEGE_NAME" ErrorMessage="Privilege Name Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_NAME2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_NAME2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_DESC1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_DESC1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox TextMode="MultiLine" ID="txtPRIVILEGE_DESC" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPRIVILEGE_DESC" runat="server" ControlToValidate="txtPRIVILEGE_DESC" ErrorMessage="Privilege Desc Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_DESC2h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_DESC2h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblACTIVE_FLAG1s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtACTIVE_FLAG1s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:CheckBox ID="cbACTIVE_FLAG" runat="server" Checked="true" />
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_NAME11s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_NAME11s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtPRIVILEGE_NAME1" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPRIVILEGE_NAME1" runat="server" ControlToValidate="txtPRIVILEGE_NAME1" ErrorMessage="Privilege Name1 Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_NAME12h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_NAME12h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group" style="color: ">
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_NAME21s" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_NAME21s" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                    <div class="col-md-8">
                                                                        <asp:TextBox ID="txtPRIVILEGE_NAME2" runat="server" CssClass="form-control"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPRIVILEGE_NAME2" runat="server" ControlToValidate="txtPRIVILEGE_NAME2" ErrorMessage="Privilege Name2 Required." CssClass="Validation" ValidationGroup="s"></asp:RequiredFieldValidator>
                                                                    </div>
                                                                    <asp:Label runat="server" ID="lblPRIVILEGE_NAME22h" class="col-md-4 control-label"></asp:Label><asp:TextBox runat="server" ID="txtPRIVILEGE_NAME22h" class="col-md-4 control-label" Visible="false"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <asp:Label runat="server" ID="lblhPRIVILEGE_NAME" Text="Privilege Name"></asp:Label></th>
                                                        <th>
                                                            <asp:Label runat="server" ID="lblhPRIVILEGE_DESC" Text="Privilege Desc"></asp:Label></th>
                                                        <th>
                                                            <asp:Label runat="server" ID="lblhPRIVILEGE_NAME1" Text="Privilege Name1"></asp:Label></th>
                                                        <th>
                                                            <asp:Label runat="server" ID="lblhPRIVILEGE_NAME2" Text="Privilege Name2"></asp:Label></th>

                                                        <th style="width: 60px;">ACTION</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <asp:ListView ID="Listview1" runat="server" OnItemCommand="Listview1_ItemCommand" DataKey="TENANT_ID,PRIVILEGE_ID,PRIVILEGE_NAME,PRIVILEGE_DESC,ACTIVE_FLAG,CRUP_ID,MODULE_ID,PRIVILEGE_NAME1,PRIVILEGE_NAME2" DataKeyNames="TENANT_ID,PRIVILEGE_ID,PRIVILEGE_NAME,PRIVILEGE_DESC,ACTIVE_FLAG,CRUP_ID,MODULE_ID,PRIVILEGE_NAME1,PRIVILEGE_NAME2">
                                                        <LayoutTemplate>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblPRIVILEGE_NAME" runat="server" Text='<%# Eval("PRIVILEGE_NAME")%>'></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="lblPRIVILEGE_DESC" runat="server" Text='<%# Eval("PRIVILEGE_DESC")%>'></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="lblPRIVILEGE_NAME1" runat="server" Text='<%# Eval("PRIVILEGE_NAME1")%>'></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="lblPRIVILEGE_NAME2" runat="server" Text='<%# Eval("PRIVILEGE_NAME2")%>'></asp:Label></td>
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:LinkButton ID="btnEdit" CommandName="btnEdit" CommandArgument='<%# Eval("PRIVILEGE_ID")%>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom"><i class="fa fa-pencil"></i></asp:LinkButton></td>
                                                                            <td>
                                                                                <asp:LinkButton ID="btnDelete" CommandName="btnDelete" OnClientClick="return ConfirmMsg();" CommandArgument='<%# Eval("PRIVILEGE_ID")%>' runat="server" class="btn btn-sm red filter-cancel"><i class="fa fa-times"></i></asp:LinkButton></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
