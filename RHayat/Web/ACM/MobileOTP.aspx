<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileOTP.aspx.cs" Inherits="Web.ACM.MobileOTP" %>
...
<body>
    ...
    <div>
    <a class="btn default" data-toggle="modal" href="#responsive" style="margin-left: 639px;"> MobileOTP</a>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="scroller" style="height:300px" data-always-visible="1" data-rail-visible1="1">
												<div class="row">
													<div class="col-md-6" style="margin-left: 114px;">
													
														<p align ="center">
															<input type="text" class="col-md-12 form-control" placeholder="Mobile Number" required>
														</p>
														
                                                        <asp:Button ID="btnotp" runat="server" Text="Get OTP" OnClick="btnotp_Click" CssClass="btn btn-info"/>
                                                    </div>
												</div>
											</div>
										</div>
