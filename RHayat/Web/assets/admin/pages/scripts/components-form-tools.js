var ComponentsFormTools = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        if (Metronic.isRTL()) {
            $('#ContentPlaceHolder1_txtWebsite').attr("dir", "rtl");
        }
        $('#ContentPlaceHolder1_txtWebsite').typeahead(null, {
            displayKey: 'num',
            hint: (Metronic.isRTL() ? false : true),
            source: numbers.ttAdapter()
        });
    ...
    var handleBootstrapMaxlength = function() {
        ...
        $('#ContentPlaceHolder1_txtRefTyep').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtSubtype').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtDescriptionAdmin').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtswitchadmin').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRemarksadmin').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtStartSerial').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRemarks').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtSortNo').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtSwitch2').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtSwitch1').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRefNameCH').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRefNameO').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRefName').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtShortname').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRefSubType').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRefType').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtEndSerial').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtCatName').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtcatname1').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtcatname2').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtWarranty').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtSupplierPer').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRef').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtContactName').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtContact3').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtPostalCode').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtZipCode').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtCity').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtAddress').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtAddress2').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_tags_2').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_RightPNTaskTOAppoint_tags_2').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_tags_3').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_tags_4').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtMobileNo').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtCustomerName').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtCustomer').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtCustomer2').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtWebsite').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtcUserName').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtcPassword').maxlength({
            alwaysShow: true,
            warningClass: "label label-success",
            limitReachedClass: "label label-danger",
            separator: ' out of ',
        ...
        $('#ContentPlaceHolder1_txtRemark').maxlength({
            limitReachedClass: "label label-danger",
            separator: ' out of ',
            preText: 'You typed ',
            postText: ' chars available.',
        ...
        $('#ContentPlaceHolder1_txtNoteHD').maxlength({
            limitReachedClass: "label label-danger",
            alwaysShow: true
        });

        $('#ContentPlaceHolder1_txtDescription').maxlength({
            limitReachedClass: "label label-danger",
            alwaysShow: true
        });
    ...
    var handleTagsInput = function () {
        ...
        $('#ContentPlaceHolder1_tags_1').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        ...
        $('#ContentPlaceHolder1_tags_2').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        });
        //CRM/PanelAppointTolls/usercuntrol
        $('#ContentPlaceHolder1_RightPNTaskTOAppoint_tagsFax').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        });
        $('#ContentPlaceHolder1_RightPNTaskTOAppoint_txtMail').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        });
        $('#ContentPlaceHolder1_RightPNTaskTOAppoint_txtWhatsup').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        });
        $('#ContentPlaceHolder1_RightPNTaskTOAppoint_txtSocialMedia').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        });
        $('#ContentPlaceHolder1_tags_3').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        });
        $('#ContentPlaceHolder1_txtMobileNo').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        ...
        $('#ContentPlaceHolder1_tags_4').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        });
        $('#ContentPlaceHolder1_txtrefreshno').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        ...
        $('#ContentPlaceHolder1_txtMoreItenKeyword').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        ...
        $('#ContentPlaceHolder1_tags_5').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        ...
        $('#txtMETAKEYWORD_tagsinput').tagsInput({
            width: 'auto',
            'onAddTag': function () {
                //alert(1);
            },
        ...
        $('#ContentPlaceHolder1_RightPNTaskTOAppoint_tags_2').tagsInput({
            width: 300
        });
    }
