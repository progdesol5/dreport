<%@ Page Title="" Language="C#" MasterPageFile="~/CRM/CRMMaster.Master" AutoEventWireup="true" CodeBehind="FrontDashBoard.aspx.cs" Inherits="Web.CRM.FrontDashBoard" %>
                                                    ...
                                                    <div class="tab-content no-space">
                                                        <div class="form-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <asp:DropDownList ID="DrpTenent_ID" Enabled="false" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="DrpTenent_ID_SelectedIndexChanged"></asp:DropDownList>
                                                                    <%--<asp:DropDownList ID="DrpTenent_ID" Enabled="false" runat="server" class="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="DrpTenent_ID_SelectedIndexChanged">
                                                                    </asp:DropDownList>--%>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <asp:DropDownList ID="Drp_Location" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="Drp_Location_SelectedIndexChanged"></asp:DropDownList>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <asp:Label ID="lblMOBPHONE" runat="server" Text='<%# Eval("Description") %>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="lblEMAIL" runat="server" Text='<%# Convert.ToDateTime(Eval("UPDTTIME")).ToShortDateString() %>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:LinkButton ID="btnACTIVITYEdit" CommandName="btnEditACTIVITY" CommandArgument='<%# Eval("TenantID") +"," + Eval("MasterCODE") %>' runat="server" class="btn btn-sm yellow filter-submit margin-bottom">Activity</asp:LinkButton>
                                                                    </td>
                                                            ...
                                                            <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand" OnItemDataBound="ListView1_ItemDataBound">
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lblMOBPHONE" runat="server" Text='<%# Eval("GROUPCODE") %>'></asp:Label></td>

                                                                        <td>
                                                                            <asp:Label ID="lblZIPCODE" runat="server" Text='<%# Eval("Version") %>'></asp:Label>
                                                                             <asp:Label ID="lblMylinenumber" runat="server" Visible="false" Text='<%# Eval("MyLineNo") %>'></asp:Label>
                                                                        </td>
                                                                        <td style="padding-left: 60px;">
                                                                            <asp:LinkButton ID="btnACTIVITYEdit" CommandName="btnEdit" CommandArgument='<%# Eval("MyLineNo")%>' runat="server"  class="btn btn-sm yellow filter-submit margin-bottom"></asp:LinkButton>
                                                                        </td>
        ...
        <div class="form-group">
                  <div class="col-md-12">
                    ...
                    <asp:Label ID="Label39" runat="server" Text="Subject:" ></asp:Label></div> 
                      <div class="col-md-10">
                           <asp:TextBox  ID="TextBox16" runat="server" class="form-control" maxlength="50"></asp:TextBox>
                      </div>
                           </div>   
            </div>   
                                                                                        <div class="form-group">
                  ...
                  <div class="col-md-2">
                           <asp:TextBox  ID="TextBox17" runat="server"  class="form-control" maxlength="50"></asp:TextBox>
                      </div>
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                           <asp:TextBox  ID="TextBox18" runat="server" class="form-control"  maxlength="50"></asp:TextBox>
                      </div>
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                           <asp:TextBox  ID="TextBox19" runat="server" class="form-control" maxlength="50"></asp:TextBox>
               ...
               <div class="col-md-2">
                           <asp:TextBox  ID="TextBox20" runat="server" class="form-control" maxlength="50"></asp:TextBox>
                      </div>
              <div class="col-md-1">
                    <asp:Label ID="Label46" class="col-md-1 control-label" runat="server" Text="Time:" ></asp:Label>
                                                                                                </div>   
                      <div class="col-md-3">
                           <asp:TextBox  ID="TextBox21" runat="server" class="form-control" maxlength="50"></asp:TextBox>
                      </div>
               <div class="col-md-1">
                    <asp:Label ID="Label47" class="col-md-1 control-label" runat="server" Text="Owner:" ></asp:Label>
                                                                                                </div>
                      <div class="col-md-3">
                           <asp:TextBox  ID="TextBox22" runat="server" class="form-control" maxlength="50"></asp:TextBox>
                      
                           </div>   
            </div></div> </div>
        <div class="modal-footer">
           <asp:LinkButton ID="LinkButton7" class="btn green-haze modalBackgroundbtn-circle" ValidationGroup="S" runat="server"> Save</asp:LinkButton>
