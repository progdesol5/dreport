<%@ Page Title="" Language="C#" MasterPageFile="~/CRM/CRMMaster.Master" AutoEventWireup="true" CodeBehind="TestSerchRecoed.aspx.cs" Inherits="Web.CRM.TestSerchRecoed" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        //$(function () {
        //    $("#tblCustomers [id*=ckball]").click(function () {
        //        if ($(this).is(":checked")) {
        //            $("#tblCustomers [id*=cbSelect]").attr("checked", "checked");
        //        } else {
        //            $("#tblCustomers [id*=cbSelect]").removeAttr("checked");
        //        }
        //    });
        //    $("#tblCustomers [id*=cbSelect]").click(function () {
        //        if ($("#tblCustomers [id*=cbSelect]").length == $("#tblCustomers [id*=cbSelect]:checked").length) {
        //            $("#tblCustomers [id*=ckball]").attr("checked", "checked");
        //        } else {
        //            $("#tblCustomers [id*=ckball]").removeAttr("checked");
        //        }
        //    });
        //});
    </script>
            ...
            <div class="col-md-12">
                                                        ...
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <asp:DropDownList ID="drpCountry12" runat="server" class="form-control select2" meta:resourcekey="drpCountryResource1" OnSelectedIndexChanged="drpCountry12_SelectedIndexChanged" AutoPostBack="true">
                                                                    </asp:DropDownList>
                ...
                <asp:Panel ID="Panel2" runat="server">
                    <div class="row">
                         ...
                         Entries&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList Style="width: 150px;" class="form-control input-inline " ID="drpSort" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpSort_SelectedIndexChanged">
                                                                            ...
                                                                            <div class="table-scrollable">
                                                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="sample_1_info" id="tblCustomers">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    <th>#</th>
                                                                                                    <th>
                                                                ...
                                                                <asp:Label ID="Label18" runat="server" Text="ZipCode"></asp:Label></th>--%>
                                                                                                    ...
                                                                                                    <th>
                                                                                                        <asp:CheckBox ID="ckball" runat="server" AutoPostBack="false" onchange="CheckAll(this);" /><asp:Label ID="Label23" runat="server" Text="All"></asp:Label></th>
                                                                                                ...
                                                                                                <asp:ListView ID="Listview1" runat="server" OnItemDataBound="Listview1_ItemDataBound">
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        <tr class="gradeA">
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <asp:CheckBox ID="cbSelect" runat="server" OnCheckedChanged="cbSelect_CheckedChanged" AutoPostBack="true" class="checkBoxClass" /></td>
                                    ...
                                    <asp:GridView ID="GridList" runat="server"
                                                                                                    ...
                                                                                                    RowStyle-CssClass="rowstyle" PageSize="10"
                                                                                                    AllowSorting="True"
                                                                                                     Width="100%" onpageindexchanging="GridList_PageIndexChanging"
                                                                                                   >
                      ...
                      <asp:Label ID="l0" runat="server" Text='<%# Eval("COMPNAME1")%>'></asp:Label>
                      </center>
                                                                                                            </ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                                                                            <HeaderTemplate>
                                                                                                                <center>
                       <asp:Label ID="Label2"  runat="server" Text="BannerName"></asp:Label>
                       </center>
                                                                                                            </HeaderTemplate>
                                                                                                            <ItemTemplate>
                                                                                                                <center>
                      <asp:Label ID="l1" runat="server" Text='<%# Eval("ADDR1")%>'></asp:Label>
                      </center>
                                                                                                            </ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                        ...
                                                                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                                                                            <HeaderTemplate>
                                                                                                                <center>
                       <asp:Label ID="Label3"  runat="server" Text="BannerImage"></asp:Label>
                       </center>
                                                                                                            </HeaderTemplate>
                                                                                                            <ItemTemplate>
                                                                                                                <center>
                          <%--<asp:Image ID="Image1" Height="40" ImageUrl='<%# "../uploads/Banner/"+Eval("memberID").ToString()+"-"+Eval("BannerImage") %>' runat="server" />--%>
                      <asp:Label ID="l2" runat="server" Text='<%# Eval("EMAIL1")%>'></asp:Label>
                      </center>
                                                                                                            </ItemTemplate>
                                                                                                        </asp:TemplateField>
                       ...
                       <asp:Label ID="Label4"  runat="server" Text="User Name"></asp:Label>
                                                                                                            ...
                                                                                                            <ItemTemplate>
                                                                                                                <center>
                      <asp:Label ID="l3" runat="server" Text='<%# Eval("MOBPHONE") %>'></asp:Label>
                      </center>
                                                                                                            </ItemTemplate>
                                                                                                        </asp:TemplateField>
