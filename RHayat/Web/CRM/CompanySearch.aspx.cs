...
namespace Web.CRM
{
    public partial class CompanySearch : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["ID"] != null)
                {
                    ...
                    if (ID == 1)
                        List = DB.TBLCOMPANYSETUPs.Where(p => p.BUYER == true && p.TenentID == TID).ToList();
                    else if (ID == 2)
                        List = DB.TBLCOMPANYSETUPs.Where(p => p.SALER == true && p.TenentID == TID).ToList();
                    else if (ID == 3)
                        List = DB.TBLCOMPANYSETUPs.Where(p => p.SALER == true && p.BUYER == true && p.TenentID == TID).ToList();
                    ViewState["List"] = List;
                }
                BindTitleData();
            }
        ...
        public List<Database.TBLCOMPANYSETUP> getCompanyList(List<Database.TBLCOMPANYSETUP> List1, List<Database.TBLCOMPANYSETUP> List2)
        {
            List<Database.TBLCOMPANYSETUP> Listcon = List2;
            foreach (Database.TBLCOMPANYSETUP listtemp in List1)
            {
        ...
        protected void btnfind_Click(object sender, EventArgs e)
        {
            ...
            string id6 = drpcity.SelectedValue.ToString();//txtCity.Text.Trim().ToString();
            ...
            string id31 = txtclassification.Text.Trim().ToString();
            
            string LembdaCondition = ".Where(p => p.";
            ...
            //Status1 = 1;
            List<Database.TBLCOMPANYSETUP> List1 = new List<TBLCOMPANYSETUP>();
            List<Database.TBLCOMPANYSETUP> List2 = new List<TBLCOMPANYSETUP>();
            ...
            if (id1 != null && id1 != "")
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.COMPNAME1.ToUpper().Contains(id1.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.COMPNAME1.ToUpper().Contains(id1.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id2 != "" && id2 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.COMPNAME2.ToUpper().Contains(id2.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.COMPNAME2.ToUpper().Contains(id2.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id3 != "" && id3 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.COMPNAME3.ToUpper().Contains(id3.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.COMPNAME3.ToUpper().Contains(id3.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id4 != "" && id4 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.POSTALCODE.ToUpper().Contains(id4.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id5 != "" && id5 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.ZIPCODE.ToUpper().Contains(id5.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id6 != "" && id6 != null && id6 != "0")
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.CITY.ToUpper().Contains(id6.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id7 != "" && id7 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.ADDR1.ToUpper().Contains(id7.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id8 != "" && id8 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.ADDR2.ToUpper().Contains(id8.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id9 != "" && id9 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.EMAIL1.ToUpper().Contains(id9.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id10 != "" && id10 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.FAX.ToUpper().Contains(id10.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.FAX.ToUpper().Contains(id10.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id11 != "" && id11 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.BUSPHONE1.ToUpper().Contains(id11.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id12 != "" && id12 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.MOBPHONE.ToUpper().Contains(id12.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (id13 != "" && id13 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.REMARKS.ToUpper().Contains(id13.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (cid != 0 && cid != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.COUNTRYID == cid && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
            ...
            if (SID != "" && SID != null && SID != "0")
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.STATE.ToUpper().Contains(SID.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.STATE.ToUpper().Contains(SID.Trim().ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id17 != 0 && id17 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.MYPRODID == id17 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.MYPRODID == id17 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id21 != "" && id21 != null && id21 != "0")
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.PRIMLANGUGE.ToUpper().Contains(id21.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.PRIMLANGUGE.ToUpper().Contains(id21.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id19 != "" && id19 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.WEBPAGE.ToUpper().Contains(id19.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.WEBPAGE.ToUpper().Contains(id19.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id20 != "" && id20 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.USERID.ToUpper().Contains(id20.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.USERID.ToUpper().Contains(id20.ToUpper()) && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id22 != false && id22 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.ISMINISTRY == id22 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.ISMINISTRY == id22 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id23 != false && id23 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.BUYER == id23 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.BUYER == id23 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id24 != false && id24 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.EMAISUB == id24 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.EMAISUB == id24 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id25 != false && id25 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.INHAWALLY == id25 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.INHAWALLY == id25 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id26 != false && id26 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.ISCORPORATE == id26 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.ISCORPORATE == id26 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id28 != false && id28 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.ISSMB == id28 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.ISSMB == id28 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id29 != false && id29 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.SALEDEPROD == id29 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.SALEDEPROD == id29 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id30 != false && id30 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.SALER == id30 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.SALER == id30 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            if (id31 != "" && id31 != null)
            {
                if (Status1 == 0)
                {
                    List1 = DB.TBLCOMPANYSETUPs.Where(p => p.Keyword == id31 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                else
                {
                    List1 = List.Where(p => p.Keyword == id31 && p.TenentID == TID).ToList();
                    List2 = getCompanyList(List1, List2);
                    Status1 = 1;
                }
                validationCount++;
            ...
            {
                ScriptManager.RegisterClientScriptBlock(Page, this.GetType(), "myscript", "alert('Invalid Search Parameter ,Please Minimum 3 or more parameter passed');", true);
            }
            ...
            //string Query = LembdaCondition+")";
            //ViewState["Lembdacondition"] = Query;

            List2 = List2.GroupBy(p => p.COMPID).Select(p => p.FirstOrDefault()).ToList();
        ...
        public void clen()
        {
            txtAddress.Text = txtAddress2.Text = txtcPassword.Text = txtcUserName.Text = txtCustomer.Text = txtCustomer2.Text = txtCustomerName.Text = txtMobileNo.Text = txtPostalCode.Text = txtRemark.Text = txtWebsite.Text = txtZipCode.Text = tags_2.Text = tags_3.Text = tags_4.Text = txtclassification.Text = "";
            //drpCategory.SelectedIndex = 0;//txtCity.Text =
        ...
        public void FillContractorID()
        {
            ...
            if (drpCountry12.SelectedValue != null && drpCountry12.SelectedValue != "0")
            {
        ...
        public void BindTitleData()
        {
            ...
            DrpTitle.DataSource = TitleData.OrderBy(p => p.REFNAME1);
            DrpTitle.DataTextField = "REFNAME1";
        ...
        protected void ckball_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                //ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('Please Complete First Primary Search Above us After Use List Search...');", true);
                //return;
        ...
        protected void drpCountry12_SelectedIndexChanged(object sender, EventArgs e)
        {
            string CID = drpCountry12.SelectedValue;
            bindSates(CID);
            int COUNTRYID = Convert.ToInt32(drpCountry12.SelectedValue);
        ...
        protected void drpSort_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ViewState["SaveList"] != null)
            {
                ...
                if (drpSort.SelectedValue == "3")
                    List = List.OrderBy(m => m.EMAIL).Where(p => p.Active == "Y" && p.TenentID == TID).ToList();
        ...
        protected void LinkButton10_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["SaveList"] != null)
            {
                ...
                List<TBLCOMPANYSETUP> List = Listserch.Where(p => (p.COMPNAME1.ToUpper().Contains(id1.ToUpper()) || p.COMPNAME2.ToUpper().Contains(id1.ToUpper()) || p.POSTALCODE.ToUpper().Contains(id1.ToUpper()) || p.ZIPCODE.ToUpper().Contains(id1.ToUpper()) || p.CITY.ToUpper().Contains(id1.ToUpper()) || p.ADDR1.ToUpper().Contains(id1.ToUpper()) || p.ADDR2.ToUpper().Contains(id1.ToUpper()) || p.MOBPHONE.ToUpper().Contains(id1.ToUpper()) || p.BUSPHONE1.ToUpper().Contains(id1.ToUpper()) || p.REMARKS.ToUpper().Contains(id1.ToUpper()) || p.EMAIL1.ToUpper().Contains(id1.ToUpper())) && p.TenentID == TID && p.Active == "Y").OrderBy(p => p.COMPID).ToList();
                int Showdata = Convert.ToInt32(drpShowGrid.SelectedValue);
                int Totalrec = List.Count();
                ((CRMMaster)Page.Master).Loadlist(Showdata, take, Skip, ChoiceID, lblShowinfEntry, btnPrevious1, btnNext1, Listview1, ListView3, Totalrec, List);
            }
        ...
        protected void cbSelect_CheckedChanged(object sender, EventArgs e)
        {
            for (int i = 0; i < Listview1.Items.Count(); i++)
            {
                ...
                if (cbSelect.Checked == false)
                {
                    ...
                    Database.TBLCOMPANYSETUP Obj_Option = List_MainOption1.Single(p => p.COMPID == CID && p.TenentID == TID);
        ...
        {
            int Country = Convert.ToInt32(drpCountry12.SelectedValue);
