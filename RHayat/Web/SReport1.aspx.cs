        ...
        public void secificEmailSend(string Email)
        {
            if (Request.QueryString != null && Request.QueryString["p"] == "s") ;
            {
                ...
                for (int i = 0; i < dt1.Rows.Count; i++)
                {
                    ...
                    Tablecontant += "<tr><td>" + dname + "</td><td>" + reference + "</td> <td>" + UName + " </td> <td>" + MyStatus + " </td><td>" + Patientn + " </td> <td>" + MRN + " </td><td>" + iname + " </td><td><a>" + attachmentdetail + "</a> </td><td>" + action + " </td> </tr>";

                }
                if (Flag)
                {
                    Tablecontant += " </tbody> </table>";
                    string Ourcontant = " <span style = \"font-family:Arial;font-size:10pt\"> Subject :" + sdt + "<b></b>,<br /><br />This email is reference to the Complain recorded on " + sdt1 + "," + Edt1 + " ,  <br /><br />" + Tablecontant + "<br /><br /><br /><br /><br /></span>";
