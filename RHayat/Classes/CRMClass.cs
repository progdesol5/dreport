...
namespace Classes
{
    ...
    public static class CRMClass
    {
        ...
        public static int InsertActivity(int TID = 0,int LID=0, int CID = 0, int MCID = 0, int LMID = 0, string RENo = null, string UNAME = null, string RUID = null, int Activityid = 0, string activityname = null, int UID = 0, int DocNO = 0, int Type=0,string Active="Y", string GROUPCODE = "", string prefix = null)
        {
            Database.CallEntities DB = new Database.CallEntities();
